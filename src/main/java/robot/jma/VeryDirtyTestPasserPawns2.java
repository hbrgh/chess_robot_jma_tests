...
import com.fathzer.jchess.chesslib.ai.eval.hbpg2.additional.PawnsStrucEval;
import com.github.bhlangonijr.chesslib.Board;
import com.github.bhlangonijr.chesslib.Piece;
import com.github.bhlangonijr.chesslib.Square;

public class VeryDirtyTestPasserPawns2 {
...
//				}
		...
		boolean isPawnPassed = PawnsStrucEval.isPawnPassedModernWay(pawnSq.getRank().ordinal(), pawnSq.getFile().ordinal(), 
				isBlack, board.getBitboard(Piece.WHITE_PAWN), board.getBitboard(Piece.BLACK_PAWN));
		if (isPawnPassed ) {
