...
public class TestPassedPawnsStaticPosition {
...
//		final String fen = "8/3k3p/2R5/3P4/1p2P3/4K3/7r/8 w - - 0 1";
		final String fenAfterE5E6 = "8/3k3p/2R1P3/3P4/8/1p2K3/7r/8 b - - 1 2";
		Board internal = new Board();
		internal.loadFromFen(fenAfterE5E6); 
		System.out.println(internal.toStringFromWhiteViewPoint());
		
		Hb2MyFirstEvaluator.evaluatePositionAsWhite(fenAfterE5E6);
